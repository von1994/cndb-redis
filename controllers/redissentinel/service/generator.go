...
func generateSentinelService(rc *redisv1alpha1.RedisSentinel, labels map[string]string, ownerRefs []metav1.OwnerReference) *corev1.Service {
	name := redissentinel.GetSentinelName(rc)
...
func generateRedisService(rc *redisv1alpha1.RedisSentinel, labels map[string]string, ownerRefs []metav1.OwnerReference) *corev1.Service {
...
func generateRedisMonitorService(rc *redisv1alpha1.RedisSentinel, labels map[string]string, ownerRefs []metav1.OwnerReference) *corev1.Service {
	name := redissentinel.GetRedisName(rc) + "-monitor"
	namespace := rc.Namespace
	labels = util.MergeLabels(labels, generateSelectorLabels(util.RedisRoleName, rc.Name))
...
func generateSentinelConfigMap(rc *redisv1alpha1.RedisSentinel, labels map[string]string, ownerRefs []metav1.OwnerReference) *corev1.ConfigMap {
	name := redissentinel.GetSentinelName(rc)
	namespace := rc.Namespace
...
func generateRedisConfigMap(rc *redisv1alpha1.RedisSentinel, labels map[string]string, ownerRefs []metav1.OwnerReference) *corev1.ConfigMap {
	name := redissentinel.GetRedisName(rc)
	namespace := rc.Namespace
...
func generateRedisShutdownConfigMap(rc *redisv1alpha1.RedisSentinel, labels map[string]string, ownerRefs []metav1.OwnerReference) *corev1.ConfigMap {
	name := redissentinel.GetRedisShutdownConfigMapName(rc)
	namespace := rc.Namespace
...
func generateSentinelReadinessProbeConfigMap(rc *redisv1alpha1.RedisSentinel, labels map[string]string, ownerRefs []metav1.OwnerReference) *corev1.ConfigMap {
	name := redissentinel.GetSentinelReadinessCm(rc)
	namespace := rc.Namespace
...
func generateRedisStatefulSet(rc *redisv1alpha1.RedisSentinel, labels map[string]string,
...
func generateSentinelStatefulSet(rc *redisv1alpha1.RedisSentinel, labels map[string]string, ownerRefs []metav1.OwnerReference) *appsv1.StatefulSet {
	name := redissentinel.GetSentinelName(rc)
	configMapName := redissentinel.GetSentinelName(rc)
	namespace := rc.Namespace
	...
	return &appsv1.StatefulSet{
		...
		Spec: appsv1.StatefulSetSpec{
			ServiceName: redissentinel.GetSentinelHeadlessSvc(rc),
...
func getQuorum(rc *redisv1alpha1.RedisSentinel) int32 {
	return rc.Spec.Sentinel.Replicas/2 + 1
}

func getRedisVolumeMounts(rc *redisv1alpha1.RedisSentinel) []corev1.VolumeMount {
	volumeMounts := []corev1.VolumeMount{
		//{
...
func getRedisVolumes(rc *redisv1alpha1.RedisSentinel) []corev1.Volume {
	shutdownConfigMapName := redissentinel.GetRedisShutdownConfigMapName(rc)
...
func getRedisDataVolume(rc *redisv1alpha1.RedisSentinel) *corev1.Volume {
...
func getRedisDataVolumeName(rc *redisv1alpha1.RedisSentinel) string {
	switch {
	case rc.Spec.Storage.PersistentVolumeClaim != nil:
...
func getRedisCommand(rc *redisv1alpha1.RedisSentinel) []string {
...
func getSentinelCommand(rc *redisv1alpha1.RedisSentinel) []string {
...
func newHeadLessSvcForCR(cluster *redisv1alpha1.RedisSentinel, labels map[string]string, ownerRefs []metav1.OwnerReference) *corev1.Service {
	...
	svc := &corev1.Service{
		ObjectMeta: metav1.ObjectMeta{
			Labels:          labels,
			Name:            redissentinel.GetSentinelHeadlessSvc(cluster),
